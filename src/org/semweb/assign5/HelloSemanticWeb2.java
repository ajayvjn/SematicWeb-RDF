    ...
    public class HelloSemanticWeb2 {
        ...
        public static void main(String[] args) throws IOException
        {
            ...
            HelloSemanticWeb2 hello = new HelloSemanticWeb2();
        ...
        private void populateFOAFFriends() throws IOException
        {
            ...
            InputStream inFoafInstance =
                    org.apache.jena.util.FileManager.get().open("Ontologies/FOAFFriends.rdf");
        ...
        private void addAlignment() throws IOException
        {
            ...
            org.apache.jena.rdf.model.Resource resource = schema.createResource(defaultNameSpace + "Individual");
            Property prop = schema.createProperty("http://www.w3.org/2002/07/owl#equivalentClass");
            org.apache.jena.rdf.model.Resource obj = schema.createResource("http://xmlns.com/foaf/0.1/Person");
            ...
            resource = schema.createResource
                    ("http://org.semweb/assign5/people#me");
            prop = schema.createProperty ("http://www.w3.org/2002/07/owl#sameAs");
            obj = schema.createResource("http://org.semweb/assign5/people#I1");
            schema.add(resource,prop,obj);
        ...
        public void setRestriction(Model model) throws IOException
        {
            ...
            InputStream inResInstance =
                    FileManager.get().open("Ontologies/restriction.owl");
        ...
        public void myEmailFriends(Model model)
        {
            ...
            runQuery(" select DISTINCT ?name where{?sub rdf:type <http://org.semweb/assign5/people#EmailPerson> .?sub foaf:name ?name} ", model);  //add the query string
        ...
        private void runJenaRule(Model model)
        {
            ...
            String rules = "[emailChange: (?person <http://xmlns.com/foaf/0.1/mbox> ?email), strConcat(?email, ?lit), regex( ?lit, '(.*@gmail.com)') -> (?person <http://www.w3.org/1999/02/22-rdf-syntax-ns#type> <http://org.semweb/assign5/people#GmailPerson>)]";
        ...
        {
            //just get all my email friends only - ones with email
            runQuery(" select DISTINCT ?name where{?sub rdf:type <http://org.semweb/assign5/people#GmailPerson> .?sub foaf:name ?name} ", model);  //add the query string
